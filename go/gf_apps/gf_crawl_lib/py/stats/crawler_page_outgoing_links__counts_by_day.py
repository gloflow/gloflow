...
def run(p_mongo_client,
	...
	days_lst  = []
	counts_lst = []
	top_20_domains_counts_per_day_lst = []
	for r in results:
		...
		top_20_domains_lst = None
		if len(domains_lst) > 20:
			top_20_domains_lst = domains_lst[:20]
		else:
			top_20_domains_lst = domains_lst
		#------------------

		top_20_domains__count_int = 0
		for domain_stats_map in top_20_domains_lst:
