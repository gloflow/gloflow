...
package gf_images_solo_service
...
func InitHandlers(pAuthSubsystemTypeStr string,
	...
	gf_rpc_lib.CreateHandlerHTTPwithAuth(true, "/v1/images/classify",
		func(pCtx context.Context, pResp http.ResponseWriter, pReq *http.Request) (map[string]interface{}, *gf_core.GFerror) {
			...
			if pReq.Method == "POST" {
				...
				input := &gf_images_service.GFimageClassifyInput{
				...
				// CLASSIFY
				classesLst, gfErr := gf_images_service.ImageClassify(input,
					userID,
					pJobsMngrCh,
					pServiceInfo,
					pCtx,
	...
	gf_rpc_lib.CreateHandlerHTTPwithAuth(false, "/v1/images/get",
		func(pCtx context.Context, pResp http.ResponseWriter, pReq *http.Request) (map[string]interface{}, *gf_core.GFerror) {
			...
			if pReq.Method == "GET" {
				...
				imageExport, existsBool, gfErr := gf_images_service.ImageGet(imgID, pCtx, pRuntimeSys)
				if gfErr != nil {
					return nil, gfErr
				}
	...
	gf_rpc_lib.CreateHandlerHTTPwithAuth(true, "/v1/images/upload_init",
		func(pCtx context.Context, pResp http.ResponseWriter, pReq *http.Request) (map[string]interface{}, *gf_core.GFerror) {
			...
			if pReq.Method == "GET" {
				...
				//------------------
				// UPLOAD__INIT
				uploadInfo, gfErr := gf_images_service.UploadInit(imageNameStr,
					imageFormatStr,
					flowsNamesLst,
					clientTypeStr,
					userID,
	...
	gf_rpc_lib.CreateHandlerHTTPwithAuth(true, "/v1/images/upload_complete",
		func(pCtx context.Context, pResp http.ResponseWriter, pReq *http.Request) (map[string]interface{}, *gf_core.GFerror) {
			...
			if pReq.Method == "POST" {
				...
				//------------------
				// COMPLETE
				runningJob, gfErr := gf_images_service.UploadComplete(uploadImageIDstr,
					flowsNamesLst,
					metaMap,
					userID,
					pJobsMngrCh,
	...
	gf_rpc_lib.CreateHandlerHTTPwithAuth(true, "/v1/images/upload_metrics",
		func(pCtx context.Context, pResp http.ResponseWriter, pReq *http.Request) (map[string]interface{}, *gf_core.GFerror) {
			...
			if pReq.Method == "POST" {
				...
				//------------------
				gfErr = gf_images_service.UploadMetricsCreate(uploadImageIDstr,
					clientTypeStr,
					metricsDataMap,
					userID,
					pMetrics,
	...
	gf_rpc_lib.CreateHandlerHTTPwithMux("/v1/images/c",
		func(pCtx context.Context, pResp http.ResponseWriter, pReq *http.Request) (map[string]interface{}, *gf_core.GFerror) {
			...
			if pReq.Method == "POST" {
				...
				gfErr = gf_images_service.ProcessBrowserImageCalcResult(cast_browser_jobs_runs_results_lst, pRuntimeSys)
				if gfErr != nil {
					return nil, gfErr
				}
	...
	gf_rpc_lib.CreateHandlerHTTPwithMux("/v1/images/v1/healthz",
		func(pCtx context.Context, pResp http.ResponseWriter, pReq *http.Request) (map[string]interface{}, *gf_core.GFerror) {
			return nil, nil
		},
		pHTTPmux,
