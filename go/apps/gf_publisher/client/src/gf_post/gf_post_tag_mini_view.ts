...
function init_tags_mini_view(p_tags_lst :string[],
	...
	gf_vis_lib.center_vertical_element(tags_mini_view_tags_container_element,
								post_title_element,
								p_log_fun);
	//-----------------
	//X position
	...
	const tags_mini_view_new_x                        :number = $(post_title_element).offset.left + 
																$(post_title_element).offset.width + 
																space_between_post_title_and_tags_mini_view;
	...
	const new_mini_view_y :number = $(post_title_element).offset().top + 
							 ($(post_title_element).offset().height - $(post_tags_element).offset().height)/2;
