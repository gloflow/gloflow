...
pub fn native__save_image(p_gf_img: &gf_image::GFimage,
    ...
    let img_buffer   = image::ImageBuffer::from_vec(p_gf_img.width_int, p_gf_img.height_int, img_data_lst).unwrap();
    let img :image::DynamicImage = image::ImageRgba8(img_buffer);
